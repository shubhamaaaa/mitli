        ...
        <div className="space-y-10">
          ...
          <section className="bg-white shadow-xl rounded-lg p-8 border-l-4 border-blue-600">
            ...
            <p className="text-gray-700 leading-relaxed">
              At <strong>Mitli Enterprises Private Limited</strong>, we are
              dedicated to enhancing your well-being through the power of nature.
              Our mission is to provide{" "}
              <strong>high-quality, natural products</strong> that support{" "}
              <strong>sexual health, vitality, and overall wellness</strong>.
            </p>
          </section>
          ...
          <section className="bg-white shadow-xl rounded-lg p-8 border-l-4 border-green-600">
            ...
            <p className="text-gray-700 leading-relaxed">
              We developed <strong>Shorya Prash</strong> to bring{" "}
              <strong>energy and strength</strong> into your life. Founded by a
              team of health enthusiasts, our goal is to fill the gap for effective,{" "}
              <strong>natural solutions</strong> in the market.
            </p>
          </section>
          ...
          <section className="bg-white shadow-xl rounded-lg p-8 border-l-4 border-yellow-500">
            ...
            <p className="text-gray-700 leading-relaxed">
              We prioritize <strong>quality and authenticity</strong>. Our ingredients
              are sourced from <strong>trusted suppliers</strong>, ensuring that
              every jar of <strong>Shorya Prash</strong> is packed with the goodness
              of nature. Our commitment to <strong>sustainability and ethical
              practices</strong> is at the core of everything we do.
            </p>
          </section>
          ...
          <section className="bg-white shadow-xl rounded-lg p-8 border-l-4 border-purple-600">
            ...
            <ul className="list-disc text-gray-700 ml-6 space-y-3">
              <li>
                <strong>100% Natural Ingredients:</strong> No chemicals, just pure
                herbal goodness.
              </li>
              <li>
                <strong>Research-Backed Formulation:</strong> Our products are
                developed based on traditional principles and modern research.
              </li>
              <li>
                <strong>Customer-Centric Approach:</strong> We provide exceptional
                service and support.
              </li>
            </ul>
          </section>
